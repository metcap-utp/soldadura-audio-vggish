...
arch = [
    ...
    to_Aggregator("aggregator", "(2.6,0,0)", "(vggish-east)", 3, 28, 28,
                  lcap("Aggregator", r"1$\times$256")),
    to_connection("vggish", "aggregator"),
    to_FCBlock("fc1", "(2.6,0,0)", "(aggregator-east)", 3, 32, 32,
               lcap("FC-1", r"256$\times$512")),
    to_connection("aggregator", "fc1"),
    to_FCBlock("fc2", "(2.6,0,0)", "(fc1-east)", 2.8, 28, 28,
               lcap("FC-2", r"512$\times$256")),
    to_connection("fc1", "fc2"),
    to_FCBlock("fc3", "(2.6,0,0)", "(fc2-east)", 2.5, 24, 24,
...
""",
    r"""\node[anchor=west, xshift=8pt, align=center] at (BB-EAST |- head_espesor-east) {""" + lcap("Espesor", r"128$\times$3") + r"""};""",
    r"""\node[anchor=west, xshift=8pt, align=center] at (BB-EAST |- head_electrodo-east) {""" + lcap("Electrodo", r"128$\times$4") + r"""};""",
    r"""\node[anchor=west, xshift=8pt, align=center] at (BB-EAST |- head_corriente-east) {""" + lcap("Corriente", r"128$\times$2") + r"""};""",
    r"""
\path (current bounding box.south) coordinate (BBOXS);
\begin{scope}[shift={($(BBOXS)+(-9.8,-3.5)$)}]
