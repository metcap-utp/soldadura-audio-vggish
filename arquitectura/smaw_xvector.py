...
arch = [
    ...
    to_Conv1D("conv1", "(2.6,0,0)", "(bn_input-east)", 3, 30, 30,
              lcap("Conv1D", r"256$\times$128$\times$5")),
    to_connection("bn_input", "conv1"),
    to_Conv1D("conv2", "(2.6,0,0)", "(conv1-east)", 3, 28, 28,
              lcap("Conv1D", r"256$\times$256$\times$3")),
    to_connection("conv1", "conv2"),
    to_Conv1D("conv3", "(2.6,0,0)", "(conv2-east)", 4, 26, 26,
              lcap("Conv1D", r"512$\times$256$\times$3")),
    to_connection("conv2", "conv3"),
    to_Pool("stats", "(2.6,0,0)", "(conv3-east)", 5, 22, 3, 0.8,
            lcap("Stats Pool", r"1$\times$1024", "2.3")),
    to_connection("conv3", "stats"),
    to_FC("fc_shared", "(2.6,0,0)", "(stats-east)", 2.8, 18, 3,
