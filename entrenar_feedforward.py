...
def main():
    ...
    with timer("Extracción VGGish") as get_extraction_time:
        all_features = []
    ...
    vggish_extraction_time = get_extraction_time().seconds
    ...
    if N_FOLDS == 1:
        ...
        fold_splits = list(sgkf.split(all_features, y_stratify, groups=sessions))
    ...
    new_entry = {
        ...
        "feature_extraction": {
            "from_cache": False,  # FeedForward siempre extrae inline, no usa cache
